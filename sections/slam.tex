...
\begin{table}[]
	...
	\end{tabular}
	\caption{A comparison of the three main SLAM Paradigms concerning what problem is solved in which manner and how efficient the algorithm solves it. The EKF is the most inefficient algorithm as the covariance matrix grows quadratically as the number of landmarks $m$ increases. 
	On the contrary the un-optimized Fast-SLAM approach performs better 
}
