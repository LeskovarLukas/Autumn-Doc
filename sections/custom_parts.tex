...
Fused Deposition Modeling is the most commonly and wide spread method of 3D-printing. The principle behind FDM comprises using an extrusion device to eject a thermoplastic polymer. This polymer is heated to the point of its glass transition and consequentially extruded along a predefined path.\newline Movement capabilities of 3D-printers differ between two different approaches. Most desktop 3D-printers are Cartesian-style 3D-printers, which means it moves linearly in the x, y and z dimension.
