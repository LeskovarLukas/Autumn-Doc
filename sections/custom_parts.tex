...
While printing the resin is exposed to UV light, originating from a laser, causing the photosensitive resin to harden. After the part is finished it is still in a not fully cured state. To fully cure a part further exposure to UV light is needed, this step is happening in a so called curing station. 
