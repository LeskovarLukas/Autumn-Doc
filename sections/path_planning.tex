...
\begin{table}[!ht]
	...
	\caption{Wrong data!Results of test 1 conducted on map1}
\end{table}
...
\begin{table}[!ht]
	...
	\caption{Wrong data!Results of test 2 conducted on map2}
\end{table}
...
An observation made looking at figure \ref{plot:PathPlanning2dPrec1}, that was already anticipated, is that with an increasing number of iterations the time to compute a path also increases. 
