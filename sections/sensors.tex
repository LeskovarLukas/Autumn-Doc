...
When comparing both linear regression functions it is apparent that the slope of the ZED 1 with $0.03m/m$ is more than twice as large compared to the ZED 2 at $0.01m/m$. This indicates that with increasing distance the depth-perception error increases dramatically. 
...
\begin{table}[h]
	...
	\end{tabular}
	\caption{Table containing the minimal and maximal mean errors of both the ZED 1 and ZED 2.}
	\label{tab:errorMinimaMaxima}
\end{table}

\input{sections/zedBenchmark}
