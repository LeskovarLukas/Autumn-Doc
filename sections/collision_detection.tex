...
The experiment is split into two parts: the impact of collision avoidance on the computational time of two-dimensional and three-dimensional path-finding.
